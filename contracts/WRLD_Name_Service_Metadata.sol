...
contract WRLD_Name_Service_Metadata is IWRLD_Name_Service_Metadata {
    function getMetadata(string memory _name, string memory _expiresAt) external pure returns (string memory) {
    ...
    function getImage(string memory _name, string memory _expiresAt) public pure returns (string memory) {
